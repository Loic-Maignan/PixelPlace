...
def Chat(sender_agent_name, sender_agent_uuid, service_name, arguments, token, my_data):
    ...
    igs.service_call(sender_agent_uuid, "Chat", arguments, "")
